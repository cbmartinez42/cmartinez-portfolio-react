    ...
    return (
        ...
        <div className="info-container">
          <div className="row">
            ...
            <img src="./assets/images/Chris1.jpg" alt="" className="headshot z-depth-5"></img>
          </div>
        ...
        <div className="row">  
          <div className="col s12 qc center-align ">
            <img src="./assets/images/qc-claire-cropped.jpeg" title="Claire" className="furbabies z-depth-3" alt="Claire"> </img>
            <img src="./assets/images/qc-smudge-light.jpg" title="Smudge" className="furbabies z-depth-3" alt="Smudge"> </img>
