          ...
          <div class="work-cards">
            ...
            <div class="row">
              <div class="col s12 m6 offset-1 center-align">
                <div class="card large example-container center-align  hoverable z-depth-3">
                  <div class="card-image waves-effect waves-block waves-light ">
                    <img class="activator screenshot" alt="Jenn's Hens" src="./assets/images/jenshens.PNG" />
                  </div>
              ...
              <div class="col s12 m6 center ">
                <div class="card large example-container hoverable z-depth-3">
                  <div class="card-image waves-effect waves-block waves-light ">
                    <img class="activator screenshot" alt="Answer 42" src="./assets/images/answer42.PNG" />
                  </div>
                  <div class="card-content">
            ...
            <div class="row"></div>
              ...
              <div class="col s12 m6 center-align">
                <div class="card large example-container hoverable z-depth-3">
                  <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator screenshot" alt="Boredify" src="./assets/images/boredify.png" />
                  </div>
                  <div class="card-content">
              ...
              <div class="col s12 m6">
                <div class="card large example-container center hoverable z-depth-3">
                  <div class="card-image waves-effect waves-block waves-light ">
                    <img class="activator screenshot" alt="Weather Dashboard" src="./assets/images/weatherdashboard.png" />
                  </div>
                  <div class="card-content">
